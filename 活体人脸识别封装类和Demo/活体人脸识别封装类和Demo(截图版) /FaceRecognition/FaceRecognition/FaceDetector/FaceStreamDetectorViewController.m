...
-(void)makeUI
{
    ...
    self.textLabel = [[UILabel alloc]initWithFrame:CGRectMake((ScreenWidth-150)/2, CGRectGetMaxY(imgView.frame), 150, 30)];
    ...
    //重拍图片按钮
    [self buttonWithTitle:@"重拍" frame:CGRectMake(ScreenWidth/2+50, CGRectGetMaxY(imageView.frame), 100, 30) action:@selector(didClickPhotoAgain) AddView:backView];
}
